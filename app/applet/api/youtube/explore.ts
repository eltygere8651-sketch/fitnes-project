...
export default async function handler(req: any, res: any) {
  ...
  try {
    ...
    const fallback = { id: "PLw-VjHDlEOgs658kAHR_LAaILBXb-s6Q5", title: "Top Mixes Generales", artist: "YouTube Mix", duration: "Mix", url: "https://www.youtube.com/playlist?list=PLw-VjHDlEOgs658kAHR_LAaILBXb-s6Q5", thumbnail: "https://images.unsplash.com/photo-1614613535308-eb5fbd3d2c17?auto=format&fit=crop&q=80&w=300&h=300", isPlaylist: true };
    if (data.trending.length === 0) data.trending.push({ ...fallback, id: "PL4fGSI1pDJn6O1LS0XSdF3RyO0Rq_LDeI", title: "Top Tendencias" });
    if (data.dailyTop.length === 0) data.dailyTop.push({ ...fallback, id: "PLx0sYbCqOb8TBPRdmBHs5Iftvv9CB5eXf", title: "Lo Más Nuevo" });
    if (data.top100.length === 0) data.top100.push({ ...fallback, id: "PL4fGSI1pDJn6puJdseH2Rt9sMvt9E2M4i", title: "Top 100 Popular" });
    if (data.workout.length === 0) data.workout.push({ ...fallback, id: "PLw-VjHDlEOgs658kAH_workout", title: "Gym Motivation" });
    if (data.focus.length === 0) data.focus.push({ ...fallback, id: "PLw-VjHDlEOgs658kAH_focus", title: "Focus & Relax" });
    if (data.trends.length === 0) data.trends.push({ ...fallback, id: "PL4fGSI1pDJn6O1LS0X_trends", title: "Novedades" });
    if (data.latin.length === 0) data.latin.push({ ...fallback, id: "PLx0sYbCqOb8TBPRdmBHs5Iftvv_latin", title: "Ritmos Latinos" });
    if (data.party.length === 0) data.party.push({ ...fallback, id: "PL4fGSI1pDJn6puJdseH_party", title: "Party Mix" });
    ...
    const fallback = { id: "PLw-VjHDlEOgs658kAHR_LAaILBXb-s6Q5", title: "Top Mixes Generales", artist: "YouTube Mix", duration: "Mix", url: "https://www.youtube.com/playlist?list=PLw-VjHDlEOgs658kAHR_LAaILBXb-s6Q5", thumbnail: "https://images.unsplash.com/photo-1614613535308-eb5fbd3d2c17?auto=format&fit=crop&q=80&w=300&h=300", isPlaylist: true };
    res.json({ trending: [{ ...fallback, id: "PL4fGSI1pDJn6O1LS0XSdF3RyO0Rq_LDeI", title: "Top Tendencias" }], dailyTop: [{ ...fallback, id: "PLx0sYbCqOb8TBPRdmBHs5Iftvv9CB5eXf", title: "Lo Más Nuevo" }], top100: [{ ...fallback, id: "PL4fGSI1pDJn6puJdseH2Rt9sMvt9E2M4i", title: "Top 100 Popular" }], workout: [{...fallback, title: "Gym Motivation"}], focus: [{...fallback, title: "Focus"}], trends: [{...fallback, title: "Novedades"}], latin: [{...fallback, title:"Ritmos Latinos"}], party: [{...fallback, title:"Party Mix"}] });
  }
}
