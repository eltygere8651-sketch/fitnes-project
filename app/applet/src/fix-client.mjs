...
const s1 = lines.findIndex(l => l.includes(t1));
if(s1 > -1) {
  ...
  newLines.push('          const mkFb = (id, title, imgVid) => ({ id, title, artist: "YouTube Mix", duration: "Playlist", url: `https://www.youtube.com/playlist?list=${id}`, thumbnail: `https://i.ytimg.com/vi/${imgVid}/mqdefault.jpg`, isPlaylist: true, subType: "playlist" });');
